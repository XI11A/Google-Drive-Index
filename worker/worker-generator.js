...
const clientId = '399248821650-o93s55lfik3d57s30l6099e3ke4d7jee.apps.googleusercontent.com';
const clientSecret = 'dMMbkh8brRc-ZV_japo85Tc2';
const grantType = 'authorization_code';
const redirectURI = 'urn:ietf:wg:oauth:2.0:oob';
const jsURL = 'https://raw.githubusercontent.com/XI11A/Google-Drive-Index/master/worker/worker-beta.js';

async function handleRequest(request) {
    let title = getParameterByName(request.url, 'site_name') || 'XI11A Drive Index';
...
<head>
    ...
    <title>XI11A Drive Index - Beta</title>
...
<div class="mdui-container">
    <br><br>
    <a href="https://github.com/XI11A/Google-Drive-Index"><img border="0" alt="XI11A Cloud" src="https://cdn.jsdelivr.net/gh/jscdn/svg@1.0.1/bhadoo-cloud-logo.svg" height="30px"></a><h3>Drive Index Generator - Beta</h3>
    <br>
    <div class="mdui-row">
    ...
    <center><h5>© 2020 - XI11A Cloud Cyber Systems</h5></center>
</div>
